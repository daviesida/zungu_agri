    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="d-flex justify-content-center" >
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Pest Details</h1> <hr />
              ...
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Pest Name</label>
                    <input type="text" name="pest_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Pest name">
                  </div>
                 
                  <div class="form-group">
                    <label for="exampleInputFile">Pest Description</label>
                    <input type="text" name="pest_desc" class="form-control" id="exampleInputPassword1" placeholder="Enter Pest Description">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Affected Crop</label>
                    <select name="crop_id" class="form-control">
                      <option value="crop_id1">crop_id1</option>
                      <option value="crop_id2">crop_id2</option>
                      <option value="crop_id3">crop_id3</option>
                      <option value="crop_id4">crop_id4</option>
                      <option value="crop_id5">crop_id5</option>
                    </select>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Best Pesticide</label>
                    <select name="pesticide_id" class="form-control">
                      <option value="pesticide_id1">pesticide_id1</option>
                      <option value="pesticide_id2">pesticide_id2</option>
                      <option value="pesticide_id3">pesticide_id3</option>
                      <option value="pesticide_id4">pesticide_id4</option>
                      <option value="pesticide_id5">pesticide_id5</option>
                    </select>
                  </div>
